...
* __functions file__: Name of a file that contains the function referred to in the `resources`. If the file is in the same directory as this parameters file, writing its name is enough. Otherwise, a path should be given.
