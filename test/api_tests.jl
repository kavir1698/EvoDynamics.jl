...
L = (2, 3)  # a tuple  specifying the number of loci l for each species
...
parameters = Dict(
  ...
  :N => (100, 100), # a tuple  for population size of each species
  ...
  :generations => 50 # number of generations to run the simulation
)
